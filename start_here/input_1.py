...
X        = [1,1.2]        # list of value(s) of independent parameter (M in ME=5.972e24 kg and R in RE=6.371e6 m 
fix_core = False       # fix core mass fraction? (True or False)    
cmf      = [0.32,0.3]     # list core mass fraction for each model if fix_core = True (0,1)
Si_wt    = [0.0,0.1]       # wt fraction of core made of Si (0,<1) 
O_wt     = [0.0,0.]       # wt fraction of core made of O  (0,<1)
...
CaMg     = [0.4,.33]       # list elemental Ca/Mg ratios for whole planet or JUST THE MANTLE if fix_core = True     
AlMg     = [0.1,.3]       # list elemental Al/Mg ratios for whole planet or JUST THE MANTLE if fix_core = True
